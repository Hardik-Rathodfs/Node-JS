...
const CartSidebar = ({ isOpen, onClose, cartItems }) => {
  ...
  return (
    <div className="wrap-header-cart js-panel-cart show-header-cart">
      <div className="s-full js-hide-cart" onClick={onClose}></div>
      ...
      <div className="header-cart flex-col-l p-l-65 p-r-25">
        <div className="header-cart-title flex-w flex-sb-m p-b-8">
          ...
          <div className="fs-35 lh-10 cl2 p-lr-5 pointer hov-cl1 trans-04 js-hide-cart" onClick={onClose}>
            <i className="zmdi zmdi-close"></i>
          </div>
        </div>
        
        <div className="header-cart-content flex-w js-pscroll ps ps--active-y" style={{ position: 'relative', overflow: 'hidden' }}>
